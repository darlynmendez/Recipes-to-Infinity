...
public class RTIUI extends GuiComboBox {
    ...
    static JPanel farmersButtonPanel(){
        ...
        //set color
        farmersMarketSearchPanel.setBackground(new Color(144, 238, 144));
    ...
    public static JPanel zipCodePane() {
        ...
        zipCodeMarketIdPanel.setBounds(60, 50, 50, 75);
        zipCodeMarketIdPanel.setSize(50, 50);
    ...
    public static JPanel farmersMarketSubmitPane() {
        ...
        farmersMarketSubmitPanel.setBounds(60, 50, 50, 50);
    ...
    public static JPanel findingFarmersMarketPane() {
        ...
        findingFarmersMarketPanel.setBounds(50, 50, 100, 100);
